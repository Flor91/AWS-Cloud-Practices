  ...
  (t.prototype = {
    ...
    open : function(c) {
      ...
      (b.types = []), (f = ""),
          ...
          b.bgOverlay ||
              ((b.bgOverlay =
                    x("bg").on("click" + p, function() { b.close(); })),
               (b.wrap = x("wrap")
                             .attr("tabindex", -1)
                             .on("click" + p,
                                 function(a) {
      ...
      return (
          b.isIE7 && (r += " mfp-ie7"), r && b._addClassToMFP(r),
    ...
    appendContent : function(a, c) {
      (b.content = a),
          a ? b.st.showCloseBtn && b.st.closeBtnInside &&
                      b.currTemplate[c] === !0
    ...
    addGroup : function(a, c) {
      ...
      (c.mainEl = a), c.items
                          ...
                          : ((c.isObj = !1),
                             c.delegate ? a.off(e).on(e, c.delegate, d)
    ...
    updateStatus : function(a, d) {
      if (b.preloader) {
        ...
        y("UpdateStatus", e), (a = e.status), (d = e.text), b.preloader.html(d),
      ...
      (a.fn.magnificPopup = function(c) {
        ...
        if ("string" == typeof c)
          if ("open" === c) {
            ...
            f.items ? (e = f.items[g])
                    : ((e = d), f.delegate && (e = e.find(f.delegate)),
                       (e = e.eq(g))),
  ...
  a.magnificPopup.registerModule("image", {
    ...
    proto : {
      ...
      _onImageHasSize : function(a) {
        a.img &&
            ((a.hasSize = !0), L && clearInterval(L),
             (a.isCheckingImgSize = !1), y("ImageHasSize", a),
      ...
      getImage : function(c, d) {
        ...
        if (i.length) {
          ...
          (j.className = "mfp-img"),
              ...
              (j.src = c.src), i.is("img") && (c.img = c.img.clone()),
              (j = c.img[0]),
              j.naturalWidth > 0 ? (c.hasSize = !0)
                                 : j.width || (c.hasSize = !1);
        }
        return (
            ...
            c.hasSize
                ? (L && clearInterval(L),
                   c.loadError ? (d.addClass("mfp-loading"),
                                  b.updateStatus("error", h.tError.replace(
                                                              "%url%", c.src)))
      ...
      initGallery : function() {
        ...
        return (
            ...
            c && c.enabled ? ((f += " mfp-gallery"), w(m + e, function() {
                                ...
                                c.text && (c.text = T(c.text, b.currItem.index,
                                                      b.items.length));
