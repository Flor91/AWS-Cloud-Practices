...
$(document).ready(function() {
  ...
  if (menu.length) {
    menu.slicknav(
        {prependTo : ".mobile_menu", closedSymbol : '+', openedSymbol : '-'});
  };
  // blog-menu
  ...
  $.scrollIt({
    ...
    onPageChange :
        null,     // function(pageIndex) that is called when page is changed
...
$("#close_search")
    .on("click", function() { $('#search_input_box').slideUp(500); });
// Search Toggle
$("#search_input_box").hide();
