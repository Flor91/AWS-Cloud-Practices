    ...
    t.extend(t.validator,
             {
               ...
               prototype : {
                 init : function() {
                   ...
                   t.each(
                       s,
                       function(e, i) { s[e] = t.validator.normalizeRule(i); }),
                       t(this.currentForm)
                           .validateDelegate(
                 ...
                 hideErrors :
                     function() { this.addWrapper(this.toHide).hide(); },
                 ...
                 elements : function() {
                   ...
                   return t(this.currentForm)
                       ...
                       .filter(function() {
                         return (
                             !this.name && e.settings.debug && window.console &&
                 ...
                 formatAndAdd : function(e, i) {
                   ...
                   "function" == typeof s
                       ...
                       : r.test(s) && (s = t.validator.format(
                                           s.replace(r, "{$1}"), i.parameters)),
                 ...
                 defaultShowErrors : function() {
                   ...
                   for (t = 0; this.errorList[t]; t++) {
                     ...
                     this.settings.highlight &&
                         this.settings.highlight.call(this, i.element,
                   ...
                   if (this.settings.unhighlight)
                     for (t = 0, e = this.validElements(); e[t]; t++)
                       this.settings.unhighlight.call(this, e[t],
                                                      this.settings.errorClass,
                                                      this.settings.validClass);
                 ...
                 showLabel : function(e, i) {
                   ...
                   s.length
                       ...
                       !i && this.settings.success &&
                           (s.text(""), "string" == typeof this.settings.success
               ...
               addClassRules : function(e, i) {
                 e.constructor === String ? (this.classRuleSettings[e] = i)
                     ...
                     t.each(e,
                            function(s, r) {
                              ...
                              if (r.param || r.depends) {
                                ...
                                n ? (e[s] = void 0 !== r.param ? r.param : !0)
                                  : delete e[s];
                              }
                            }),
                     t.each(
                         e,
                         function(s, r) { e[s] = t.isFunction(r) ? r(i) : r; }),
                             ...
                             success : function(s) {
                               ...
                               if (a) {
                                 ...
                                 n.prepareElement(i), (n.formSubmitted = u),
                                     ...
                                     delete n.invalid[i.name], n.showErrors();
                               } else {
                                 var o = {},
