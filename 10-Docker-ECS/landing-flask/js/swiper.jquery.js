...
var Swiper = function(container, params) {
  ...
  var defaults = {
    ...
    paginationType :
        'bullets', // 'bullets' or 'progress' or 'fraction' or 'custom'
    // Resistance
    resistance : true,
  ...
  s.setBreakpoint = function() {
    ...
    if (breakpoint && s.currentBreakpoint !== breakpoint) {
      var breakPointsParams = breakpoint in s.params.breakpoints
                                  ...
                                  : s.originalParams;
      var needsReLoop = s.params.loop && (breakPointsParams.slidesPerView !==
  ...
  if (s.params.nextButton || s.params.prevButton) {
    if (s.params.nextButton) {
      ...
      if (s.params.uniqueNavElements &&
          typeof s.params.nextButton === 'string' && s.nextButton.length > 1 &&
    ...
    if (s.params.prevButton) {
      ...
      if (s.params.uniqueNavElements &&
          typeof s.params.prevButton === 'string' && s.prevButton.length > 1 &&
  ...
  // Is Horizontal
  s.isHorizontal = function() { return s.params.direction === 'horizontal'; };
  // s.isH = isH;
  ...
  s.unsetGrabCursor = function() { s.container[0].style.cursor = ''; };
  if (s.params.grabCursor) {
    s.setGrabCursor();
  }
  /*=========================
  ...
  s.loadImage = function(imgElement, src, srcset, sizes, checkForComplete,
                         callback) {
    var image;
    function onReady() {
      if (callback)
  ...
  /*=========================
    Min/Max Translate
    ===========================*/
  s.minTranslate = function() { return (-s.snapGrid[0]); };
  s.maxTranslate = function() { return (-s.snapGrid[s.snapGrid.length - 1]); };
  /*=========================
    Slider/slides sizes
    ===========================*/
  ...
  s.updateSlidesSize = function() {
    ...
    var spaceBetween = s.params.spaceBetween,
        slidePosition = -s.params.slidesOffsetBefore, i, prevSlideSize = 0,
        index = 0;
    ...
    if (s.params.slidesPerColumn > 1) {
      ...
      if (s.params.slidesPerView !== 'auto' &&
        ...
        slidesNumberEvenToRows =
            Math.max(slidesNumberEvenToRows,
    ...
    for (i = 0; i < s.slides.length; i++) {
      ...
      if (s.params.slidesPerView === 'auto') {
        slideSize =
            s.isHorizontal() ? slide.outerWidth(true) : slide.outerHeight(true);
  ...
  s.updateSlidesProgress = function(translate) {
    ...
    for (var i = 0; i < s.slides.length; i++) {
      ...
      var slideProgress =
          (offsetCenter + (s.params.centeredSlides ? s.minTranslate() : 0) -
    ...
    for (i = 0; i < s.slidesGrid.length; i++) {
      if (typeof s.slidesGrid[i + 1] !== 'undefined') {
        if (translate >= s.slidesGrid[i] &&
          ...
          newActiveIndex = i;
        } else if (translate >= s.slidesGrid[i] &&
                   translate < s.slidesGrid[i + 1]) {
          newActiveIndex = i + 1;
        }
      } else {
  ...
  s.updateRealIndex = function() {
    s.realIndex =
        parseInt(s.slides.eq(s.activeIndex).attr('data-swiper-slide-index') ||
                     s.activeIndex,
                 10);
  };
  ...
  s.updateClasses = function() {
    ...
    if (s.paginationContainer && s.paginationContainer.length > 0) {
      ...
      var current,
          total = s.params.loop
                      ? Math.ceil((s.slides.length - s.loopedSlides * 2) /
                                  s.params.slidesPerGroup)
                      : s.snapGrid.length;
      if (s.params.loop) {
        current = Math.ceil((s.activeIndex - s.loopedSlides) /
                            s.params.slidesPerGroup);
      ...
      if (s.params.paginationType === 'progress') {
        ...
        s.paginationContainer.find('.' + s.params.paginationProgressbarClass)
            .transform('translate3d(0,0,0) scaleX(' + scaleX + ') scaleY(' +
                       scaleY + ')')
  ...
  s.updatePagination = function() {
    ...
    if (s.paginationContainer && s.paginationContainer.length > 0) {
      ...
      if (s.params.paginationType === 'bullets') {
        var numberOfBullets =
            s.params.loop ? Math.ceil((s.slides.length - s.loopedSlides * 2) /
                                      s.params.slidesPerGroup)
                          : s.snapGrid.length;
      ...
      if (s.params.paginationType === 'fraction') {
        if (s.params.paginationFractionRender) {
          paginationHTML = s.params.paginationFractionRender(
              s, s.params.paginationCurrentClass,
  ...
  s.update = function(updateTranslate) {
    ...
    function forceSetTranslate() {
      var translate = s.rtl ? -s.translate : s.translate;
      newTranslate =
          Math.min(Math.max(s.translate, s.maxTranslate()), s.minTranslate());
  ...
  s.touchEvents = {
    ...
    end : s.support.touch || !s.params.simulateTouch ? 'touchend'
  ...
  s.initEvents = function(detach) {
    ...
    if (s.params.pagination && s.params.paginationClickable) {
      s.paginationContainer[actionDom]('click', '.' + s.params.bulletClass,
                                       s.onClickIndex);
      if (s.params.a11y && s.a11y)
        s.paginationContainer[actionDom]('keydown', '.' + s.params.bulletClass,
                                         s.a11y.onEnterKey);
    }
  ...
  s.updateClickedSlide = function(e) {
    ...
    if (s.params.slideToClickedSlide && s.clickedIndex !== undefined &&
      ...
      var slideToIndex = s.clickedIndex, realIndex, duplicatedSlides,
          slidesPerView = s.params.slidesPerView === 'auto'
      ...
      if (s.params.loop) {
        if (s.animating)
          return;
        realIndex =
            parseInt($(s.clickedSlide).attr('data-swiper-slide-index'), 10);
        if (s.params.centeredSlides) {
          if ((slideToIndex < s.loopedSlides - slidesPerView / 2) ||
            ...
            slideToIndex =
                s.wrapper
                    ...
                    .eq(0)
                    .index();
            setTimeout(function() { s.slideTo(slideToIndex); }, 0);
          } else {
  ...
  var isTouched, isMoved, allowTouchCallbacks, touchStartTime, isScrolling,
      currentTranslate, startTranslate, allowThresholdMove,
  ...
  s.onTouchStart = function(e) {
    ...
    // Do NOT start if iOS edge swipe is detected. Otherwise iOS app (UIWebView)
    // cannot swipe-to-go-back anymore
    if (s.device.ios && s.params.iOSEdgeSwipeDetection &&
  ...
  s.onTouchMove = function(e) {
    ...
    if (isTouchEvent && s.params.touchReleaseOnEdges && !s.params.loop) {
      if (!s.isHorizontal()) {
        // Vertical
        if ((s.touches.currentY < s.touches.startY &&
        ...
        if ((s.touches.currentX < s.touches.startX &&
             s.translate <= s.maxTranslate()) ||
    ...
    if (typeof isScrolling === 'undefined') {
      ...
      if (s.isHorizontal() && s.touches.currentY === s.touches.startY ||
        ...
        touchAngle =
            Math.atan2(Math.abs(s.touches.currentY - s.touches.startY),
    ...
    if (s.params.freeMode) {
      ...
      if (s.params.freeModeMomentum) {
        if (velocities.length > 1) {
          ...
          // There would be no events with distance zero, so the last event is
          // stale.
          if (time > 150 ||
        ...
        if (s.velocity !== 0) {
          if (s.rtl) {
            momentumDuration =
                Math.abs((-newPosition - s.translate) / s.velocity);
          } else {
            momentumDuration =
                Math.abs((newPosition - s.translate) / s.velocity);
          }
  ...
  /*=========================
    ...
    ===========================*/
  s._slideTo = function(
      slideIndex, speed) { return s.slideTo(slideIndex, speed, true, true); };
  ...
  s._slideNext = function(speed) { return s.slideNext(true, speed, true); };
  ...
  s.slideReset = function(
      runCallbacks, speed,
      internal) { return s.slideTo(s.activeIndex, speed, runCallbacks); };
  ...
  s.setWrapperTranslate = function(translate, updateActiveIndex, byController) {
    ...
    if (!s.params.virtualTranslate) {
      if (s.support.transforms3d)
        s.wrapper.transform('translate3d(' + x + 'px, ' + y + 'px, ' + z +
                            'px)');
      else
  ...
  s.getTranslate = function(el, axis) {
    ...
    if (window.WebKitCSSMatrix) {
      ...
      transformMatrix = curStyle.MozTransform || curStyle.OTransform ||
                        curStyle.MsTransform || curStyle.msTransform ||
                        curStyle.transform ||
  ...
  function initObserver(target, options) {
    ...
    observer.observe(target, {
      ...
      childList : typeof options.childList === 'undefined' ? true
                                                           : options.childList,
  ...
  s.createLoop = function() {
    ...
    s.loopedSlides =
        parseInt(s.params.loopedSlides || s.params.slidesPerView, 10);
  ...
  s.fixLoop = function() {
    ...
    else if ((s.params.slidesPerView === 'auto' &&
  ...
  s.effects = {
    ...
    flip : {
      setTranslate : function() {
        for (var i = 0; i < s.slides.length; i++) {
          ...
          var offset = slide[0].swiperSlideOffset;
          var rotate = -180 * progress, rotateY = rotate, rotateX = 0,
              tx = -offset, ty = 0;
          if (!s.isHorizontal()) {
            ty = tx;
            tx = 0;
          ...
          slide.transform('translate3d(' + tx + 'px, ' + ty +
                          'px, 0px) rotateX(' + rotateX + 'deg) rotateY(' +
                          rotateY + 'deg)');
        }
      },
      setTransition : function(duration) {
    ...
    cube : {
      setTranslate : function() {
        ...
        for (var i = 0; i < s.slides.length; i++) {
          ...
          var transform =
              'rotateX(' + (s.isHorizontal() ? 0 : -slideAngle) +
        ...
        if (s.params.cube.shadow) {
          if (s.isHorizontal()) {
            ...
            var multiplier =
                1.5 - (Math.sin(shadowAngle * 2 * Math.PI / 360) / 2 +
    ...
    coverflow : {
      setTranslate : function() {
        ...
        var center = s.isHorizontal() ? -transform + s.width / 2
                                      : -transform + s.height / 2;
        var rotate = s.isHorizontal() ? s.params.coverflow.rotate
        ...
        for (var i = 0, length = s.slides.length; i < length; i++) {
          ...
          var translateY = s.isHorizontal() ? 0
                                            : s.params.coverflow.stretch *
                                                  (offsetMultiplier);
          ...
          var slideTransform = 'translate3d(' + translateX + 'px,' +
                               ...
                               'px)  rotateX(' + rotateX + 'deg) rotateY(' +
                               rotateY + 'deg)';
  ...
  s.lazy = {
    ...
    loadImageInSlide : function(index, loadInDuplicate) {
      ...
      img.each(function() {
        ...
        s.loadImage(
            _img[0], (src || background), srcset, sizes, false, function() {
              if (typeof s === 'undefined' || s === null || !s)
                return;
              if (background) {
              ...
              slide
                  .find('.' + s.params.lazyPreloaderClass + ', .' +
    ...
    load : function() {
      ...
      if (s.params.watchSlidesVisibility) {
        s.wrapper.children('.' + s.params.slideVisibleClass)
            .each(function() { s.lazy.loadImageInSlide($(this).index()); });
      } else {
        if (slidesPerView > 1) {
  ...
  s.scrollbar = {
    ...
    set : function() {
      ...
      if (s.params.uniqueNavElements &&
          typeof s.params.scrollbar === 'string' && sb.track.length > 1 &&
      ...
      sb.trackSize =
          s.isHorizontal() ? sb.track[0].offsetWidth : sb.track[0].offsetHeight;
  ...
  s.controller = {
    LinearSpline : function(x, y) {
      ...
      this.interpolate = function(x2) {
        ...
        // Get the indexes of x1 and x3 (the array indexes before and after
        // given x2):
    ...
    setTranslate : function(translate, byController) {
      ...
      function setControlledTranslate(c) {
        ...
        // x is the Grid of the scrolled scroller and y will be the controlled
        // scroller it makes sense to create this only once and recall it for
        // the interpolation the function does a lot of value caching for
        // performance
        translate = c.rtl && c.params.direction === 'horizontal' ? -s.translate
                                                                 : s.translate;
        if (s.params.controlBy === 'slide') {
          s.controller.getInterpolateFunction(c);
          // i am not sure why the values have to be multiplicated this way,
          // tried to invert the snapGrid but it did not work out
  ...
  s.hashnav = {
    onHashCange : function(e, a) {
      ...
      if (newHash !== activeSlideHash) {
        s.slideTo(s.wrapper
                      .children('.' + s.params.slideClass + '[data-hash="' +
                                (newHash) + '"]')
                      .index());
      }
    },
  ...
  function isEventSupported() {
    ...
    if (!isSupported && document.implementation &&
   ...
   * complicated, thus this doc is long and (hopefully) detailed enough to
   ...
   *   pixelY  -- " - y plane
   *
   * Wheel values are provided by the browser assuming you are using the wheel
   * to scroll a web page by a number of lines or pixels (or pages).  Values can
   * vary significantly on different platforms and browsers, forgetting that you
   * can scroll at different speeds.  Some devices (like trackpads) emit more
   * events at smaller increments with fine granularity, and some emit massive
   * jumps with linear speed or acceleration.
   *
   ...
   *
   * On other/older browsers.. it's more complicated as there can be multiple
   * and also missing delta values.
   *
   * The 'wheel' event is more standard:
   *
   * http://www.w3.org/TR/DOM-Level-3-Events/#events-wheelevents
   *
   * The basics is that it includes a unit, deltaMode (pixels, lines, pages),
   * and deltaX, deltaY and deltaZ.  Some browsers provide other values to
   * maintain backward compatibility with older events.  Those other values help
   * us better normalize spin speed.  Example of what the browsers provide:
   *
  ...
  if (s.params.mousewheelControl) {
    /**
     * The best combination if you prefer spinX + spinY normalization.  It
     * favors the older DOMMouseScroll for Firefox, as FF does not include
     * wheelDelta with 'wheel' event, making spin speed determination
     * impossible.
     */
    s.mousewheel.event = (navigator.userAgent.indexOf('firefox') > -1)
                             ? 'DOMMouseScroll'
                             : isEventSupported() ? 'wheel' : 'mousewheel';
  }
  function handleMousewheel(e) {
    ...
    if (s.params.mousewheelForceToAxis) {
      ...
      delta = Math.abs(data.pixelX) > Math.abs(data.pixelY)
    ...
    if (!s.params.freeMode) {
      ...
      if (s.params.freeModeSticky) {
        ...
        s.mousewheel.timeout = setTimeout(function() { s.slideReset(); }, 300);
      } else {
  ...
  s.zoom = {
    ...
    getDistanceBetweenTouches : function(e) {
      if (e.targetTouches.length < 2)
        return 1;
      var x1 = e.targetTouches[0].pageX, y1 = e.targetTouches[0].pageY,
          x2 = e.targetTouches[1].pageX, y2 = e.targetTouches[1].pageY;
    ...
    onGestureStart : function(e) {
      ...
      if (!z.gesture.slide || !z.gesture.slide.length) {
        ...
        z.gesture.imageWrap =
            z.gesture.image.parent('.' + s.params.zoomContainerClass);
        z.gesture.zoomMax =
    ...
    onGestureEnd : function(e) {
      ...
      if (!z.gesture.image || z.gesture.image.length === 0)
        return;
      z.scale =
          Math.max(Math.min(z.scale, z.gesture.zoomMax), s.params.zoomMin);
    ...
    onTouchMove : function(e) {
      ...
      if (scaledWidth < z.gesture.slideWidth &&
      ...
      z.image.minY =
          Math.min((z.gesture.slideHeight / 2 - scaledHeight / 2), 0);
      ...
      z.gesture.imageWrap.transform('translate3d(' + z.image.currentX + 'px, ' +
                                    z.image.currentY + 'px,0)');
    },
    onTouchEnd : function(s, e) {
      ...
      if (z.velocity.y !== 0)
        momentumDurationY =
            Math.abs((newPositionY - z.image.currentY) / z.velocity.y);
      ...
      z.image.maxY = -z.image.minY;
      z.image.currentX =
          Math.max(Math.min(z.image.currentX, z.image.maxX), z.image.minX);
      z.image.currentY =
          Math.max(Math.min(z.image.currentY, z.image.maxY), z.image.minY);

      z.gesture.imageWrap.transition(momentumDuration)
          .transform('translate3d(' + z.image.currentX + 'px, ' +
                     z.image.currentY + 'px,0)');
    },
    ...
    toggleZoom : function(s, e) {
      ...
      if (!z.gesture.slide) {
        z.gesture.slide =
            s.clickedSlide ? $(s.clickedSlide) : s.slides.eq(s.activeIndex);
        z.gesture.image = z.gesture.slide.find('img, svg, canvas');
        z.gesture.imageWrap =
            z.gesture.image.parent('.' + s.params.zoomContainerClass);
      }
      ...
      if (z.scale && z.scale !== 1) {
        ...
        z.gesture.image.transition(300).transform(
        ...
        z.gesture.image.transition(300).transform('translate3d(0,0,0) scale(' +
                                                  z.scale + ')');
      }
    },
    // Attach/Detach Events
    ...
    destroy : function() { s.zoom.attachEvents(true); }
  };
  ...
  s.emit = function(eventName) {
    ...
    // Trigger plugins
    if (s.callPlugins)
      s.callPlugins(eventName, arguments[1], arguments[2], arguments[3],
                    arguments[4], arguments[5]);
  };
    ...
    initPagination : function() {
      if (s.params.pagination && s.params.paginationClickable && s.bullets &&
        ...
        s.bullets.each(function() {
          ...
          s.a11y.addLabel(bullet, s.params.paginationBulletMessage.replace(
                                      /{{index}}/, bullet.index() + 1));
        });
      }
    },
    destroy : function() {
  ...
  s.init = function() {
    ...
    // Deprecated hashnavReplaceState changed to replaceState for use in hashnav
    // and history
  ...
  s.cleanupStyles = function() {
    ...
    if (s.slides && s.slides.length) {
      s.slides
          .removeClass([
            s.params.slideVisibleClass, s.params.slideActiveClass,
            s.params.slideNextClass, s.params.slidePrevClass
          ].join(' '))
          .removeAttr('style')
...
Swiper.prototype = {
  ...
  browser : {
    ...
    lteIE9 : (function() {
      ...
      // add content to tmp DIV which is wrapped into the IE HTML conditional
      // statement
    ...
    transforms3d : (window.Modernizr && Modernizr.csstransforms3d === true) ||
                       (function() {
                         ...
                         return (
                             ...
                             'MozPerspective' in div || 'OPerspective' in div ||
    ...
    domLib.fn.transform = function(transform) {
      for (var i = 0; i < this.length; i++) {
        ...
        elStyle.webkitTransform = elStyle.MsTransform = elStyle.msTransform =
            elStyle.MozTransform = elStyle.OTransform = elStyle.transform =
                transform;
      }
      return this;
    };
      ...
      for (var i = 0; i < this.length; i++) {
        ...
        elStyle.webkitTransitionDuration = elStyle.MsTransitionDuration =
            elStyle.msTransitionDuration = elStyle.MozTransitionDuration =
                elStyle.OTransitionDuration = elStyle.transitionDuration =
                    duration;
      }
      return this;
    };
