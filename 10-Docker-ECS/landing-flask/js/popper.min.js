...
function f(e, t) {
  ...
  return ((e.top += n * r), (e.bottom += n * r), (e.left += i * r),
          (e.right += i * r), e);
}
function m(e, t) {
...
function u(e) {
  ...
  var p = {
    ...
    height : o.bottom - o.top,
      ...
      a = s.height || e.clientHeight || p.bottom - p.top, f = e.offsetWidth - d,
      h = e.offsetHeight - a;
  if (f || h) {
    var u = t(e);
...
function b(e, o) {
  ...
  if (((b.marginTop = 0), (b.marginLeft = 0), !p && s)) {
    ...
    (b.top -= h - w), (b.bottom -= h - w), (b.left -= c - y),
  ...
  if ("viewport" === r)
    ...
    if ("HTML" === l.nodeName && !y(d)) {
      ...
      (s.top += f.top - f.marginTop), (s.bottom = h + f.top),
          (s.left += f.left - f.marginLeft), (s.right = g + f.left);
    } else
      s = f;
  }
  i = i || 0;
      ...
      modifiers : {
        ...
        arrow : {
          ...
          fn : function(e, o) {
            ...
            return (
                (v = ee(Q(s[l] - u, v), 0)), (e.arrowElement = i),
        ...
        computeStyle : {
          ...
          fn : function(e, t) {
            ...
            var s, d, a = void 0 === r ? t.gpuAcceleration : r,
                      ...
                      g = "right" === n ? "left" : "right", b = H("transform");
        ...
        applyStyle : {
          ...
          onLoad : function(e, t, o, n, i) {
            var r = L(i, t, e, o.positionFixed),
                p = O(o.placement, r, t, e, o.modifiers.flip.boundariesElement,
