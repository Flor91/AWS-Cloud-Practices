...
(function(e, t, n, r) {
function d(t, n) {
  this.element = t, this.options = e.extend({}, s, n), this._defaults = s,
...
d.prototype = {
  init : function() {
    ...
    this._defineElements(), this._defineGetters(), this._defineSetters(),
    this._handleWindowLoadAndResize(), this._detectViewport(),
    this.refresh({firstLoad : !0}),
    this.options.scrollProperty === "scroll" ? this._handleScrollEvent()
  ...
  _defineGetters : function() {
    ...
    this._getScrollLeft = function() { return t.getLeft(e.$scrollElement) },
    this._getScrollTop = function() { return t.getTop(e.$scrollElement) }
  },
  _defineSetters : function() {
    var t = this, n = o[t.options.scrollProperty],
        r = u[t.options.positionProperty], i = n.setLeft, s = n.setTop;
    this._setScrollLeft = typeof i == "function"
                              ? function(e) { i(t.$scrollElement, e) }
                              : e.noop,
    this._setScrollTop = typeof s == "function"
                             ? function(e) { s(t.$scrollElement, e) }
                             : e.noop,
  ...
  _handleWindowLoadAndResize : function() {
    ...
    n.options.responsive &&
        r.bind("load." + this.name, function() { n.refresh() }),
  ...
  refresh : function(n) {
    ...
    (!n || !n.firstLoad) && this._reset(), this._setScrollLeft(0),
        this._setScrollTop(0), this._setOffsets(), this._findParticles(),
        this._findBackgrounds(),
        n && n.firstLoad && /WebKit/.test(navigator.userAgent) &&
            e(t).load(function() {
              var e = r._getScrollLeft(), t = r._getScrollTop();
              r._setScrollLeft(e + 1), r._setScrollTop(t + 1),
                  r._setScrollLeft(e), r._setScrollTop(t)
            }),
  ...
  _findParticles : function() {
    ...
    this.$element.find("[data-stellar-ratio]").each(function(n) {
      ...
      t.options.showElement(i),
          ...
          u = i.position().left, a = i.position().top,
          f = i.css("margin-left") === "auto"
                  ? 0
                  : parseInt(i.css("margin-left"), 10),
          l = i.css("margin-top") === "auto"
                  ? 0
                  : parseInt(i.css("margin-top"), 10),
          h = i.offset().left - f, p = i.offset().top - l,
  ...
  _findBackgrounds : function() {
    ...
    s.each(function() {
      var s = e(this), o = h(s), u, a, f, l, p, d, v, m, g, y = 0, b = 0, w = 0,
          E = 0;
      ...
      s.data("stellar-backgroundStartingLeft")
          ...
          t.backgrounds.push({
            ...
            startingBackgroundPositionLeft :
                isNaN(parseInt(o[0], 10)) ? 0 : parseInt(o[0], 10),
            startingBackgroundPositionTop :
                isNaN(parseInt(o[1], 10)) ? 0 : parseInt(o[1], 10),
            ...
            parentOffsetLeft : y,
            parentOffsetTop : b,
            stellarRatio : s.data("stellar-background-ratio") === r
                               ? 1
            ...
            : this.horizontalOffset = this.options.horizontalOffset,
              typeof this.options.verticalOffset == "function"
                  ? (this.verticalOffset = this.options.verticalOffset(),
                     r.bind("resize.vertical-" + this.name,
                            function() {
  ...
  _repositionElements : function() {
    var e = this._getScrollLeft(), t = this._getScrollTop(), n, r, i, s, o, u,
        a, f = !0, l = !0, h, p, d, v, m;
    if (this.currentScrollLeft === e && this.currentScrollTop === t &&
        this.currentWidth === this.viewportWidth &&
        this.currentHeight === this.viewportHeight)
      return;
    this.currentScrollLeft = e, this.currentScrollTop = t,
    this.currentWidth = this.viewportWidth,
    this.currentHeight = this.viewportHeight;
    for (m = this.particles.length - 1; m >= 0; m--)
      i = this.particles[m], s = i.isFixed ? 1 : 0,
      this.options.horizontalScrolling
          ? (h = (e + i.horizontalOffset + this.viewportOffsetLeft +
                  i.startingPositionLeft - i.startingOffsetLeft +
                  i.parentOffsetLeft) *
                     -(i.stellarRatio + s - 1) +
      ...
      this.options.verticalScrolling
          ? (p = (t + i.verticalOffset + this.viewportOffsetTop +
                  i.startingPositionTop - i.startingOffsetTop +
                  i.parentOffsetTop) *
                     -(i.stellarRatio + s - 1) +
      ...
      this.options.hideDistantElements &&
          (l = !this.options.horizontalScrolling ||
               d + i.width > (i.isFixed ? 0 : e) &&
                   d < (i.isFixed ? 0 : e) + this.viewportWidth +
                           this.viewportOffsetLeft,
           f = !this.options.verticalScrolling ||
               v + i.height > (i.isFixed ? 0 : t) &&
                   v < (i.isFixed ? 0 : t) + this.viewportHeight +
                           this.viewportOffsetTop),
      l && f ? (i.isHidden &&
                    (this.options.showElement(i.$element), i.isHidden = !1),
                this._setPosition(i.$element, h, i.startingPositionLeft, p,
                                  i.startingPositionTop))
             : i.isHidden ||
                   (this.options.hideElement(i.$element), i.isHidden = !0);
    for (m = this.backgrounds.length - 1; m >= 0; m--)
      o = this.backgrounds[m], s = o.isFixed ? 0 : 1,
      u = this.options.horizontalScrolling
              ? (e + o.horizontalOffset - this.viewportOffsetLeft -
                 o.startingOffsetLeft + o.parentOffsetLeft -
                 o.startingBackgroundPositionLeft) *
                        (s - o.stellarRatio) +
                    "px"
              : o.startingValueLeft,
      a = this.options.verticalScrolling
              ? (t + o.verticalOffset - this.viewportOffsetTop -
                 o.startingOffsetTop + o.parentOffsetTop -
  ...
  _handleScrollEvent : function() {
    var e = this, t = !1, n = function() { e._repositionElements(), t = !1 },
    ...
    e.fn[i] = function(t) {
      ...
      if (typeof t == "string" && t[0] !== "_" && t !== "init")
        return this.each(function() {
          ...
          r instanceof d && typeof r[t] == "function" &&
...
/**!
 * @author odahcam
 * @see The boilerplate used here was
 *     https://github.com/odahcam/jQueryPlugin-Boilerplate
...
for (var j = 0; j < l.length && !f.requestAnimationFrame; ++j) {
  ...
  f.cancelAnimationFrame = f[l[j] + "CancelAnimationFrame"] ||
...
if (!f.cancelAnimationFrame) {
  f.cancelAnimationFrame = function(m) { clearTimeout(m) }
}
})();
var e = "parallax", c = {on : "scroll", listenTo : f, sceneMode : false},
    a = d(f), i = 0;
function h(k, j) {
  this._name = e;
  this._instance_id = ++i;
...
d.extend(h.prototype, {
  init : function() {
    var j = this;
    this.$triggerOrigin.on(j.settings.on + "." + j._name,
                           function() { j.parallaxTranslate() });
    j.parallaxTranslate()
  },
  ...
  inScreen : function(l) {
    ...
    var k = a.scrollTop(), n = k + a.height(), j = o.offset().top,
        m = j + o.height();
    if (l === true) {
      return k <= j && n >= m
    }
