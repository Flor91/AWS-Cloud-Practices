...
!function(a, b, c, d) {
  function e(b, c) {
    ...
    this._items = [], this._clones = [], this._mergers = [], this._widths = [],
      ...
      [
        ...
        },
        {
          ...
          run : function(a) {
            ...
            for (a.items = {merge : !1, width : b}; d--;)
              c = this._mergers[d],
              c = this.settings.mergeFit && Math.min(c, this.settings.items) ||
                  c,
        ...
        },
        {
          ...
          run : function(a) {
            ...
            a.current =
                Math.max(this.minimum(), Math.min(this.maximum(), a.current)),
  ...
  e.prototype.initializeStage = function() {
    ...
    b.clearTimeout(this.resizeTimer),
        this.resizeTimer = b.setTimeout(this._handlers.onResize,
    ...
    3 !== b.which &&
        (a.support.transform
             ...
             : (d = this.$stage.position(), d = {
                 x : this.settings.rtl ? d.left + this.$stage.width() -
         ...
         this._drag.stage.current = d, this._drag.pointer = this.pointer(b),
    ...
    if (a = this.normalize(a), this._current !== a) {
      var b =
          this.trigger("change", {property : {name : "position", value : a}});
      b.data !== d && (a = this.normalize(b.data)),
          this._current = a, this.invalidate("position"),
          this.trigger("changed",
    ...
    return b === d ? a.map(this._clones, function(a, b) { return f(b) })
                   : a.map(this._clones,
    ...
    return b === d
               ...
               : (this.settings.center
                      ? (this.settings.rtl && (e = -1, f = b + 1),
                         ...
                         c += (this.width() - c + (this._coordinates[f] || 0)) /
                              2 * e)
    ...
    this.trigger("add", {content : b, position : c}), b = this.prepare(b),
    ...
    this.invalidate("items"), this.trigger("added", {content : b, position : c})
    ...
    return this.each(function() {
      ...
      f || (f = new e(this, "object" == typeof b && b),
            ...
            a.each(
                [
                  "next", "prev", "to", "destroy", "refresh", "replace", "add",
                  "remove"
                ],
                function(b, c) {
            ...
            a(b).resize(function() {
              d._core.settings.autoHeight &&
                  (null != d._intervalId && clearTimeout(d._intervalId),
                   d._intervalId = setTimeout(function() { d.update() }, 250))
            })
      };
    ...
    function(a, b, c, d) {
      ...
      e.prototype.fetch = function(a, b) {
        ...
        d = d[6], this._videos[g] = {type : c, id : d, width : e, height : f},
        ...
        this._playing ||
            (this._core.enter("playing"),
             ...
             "youtube" === f.type ? c = '<iframe width="' + g + '" height="' +
                                        h + '" src="//www.youtube.com/embed/' +
                                        f.id + "?autoplay=1&rel=0&v=" + f.id +
    ...
    function(a, b, c, d) {
      ...
      e.prototype._next = function(d) {
        ...
        this._core.is("rotating") &&
            (this._time = 0, this._paused = !0, b.clearTimeout(this._call),
      ...
      e.prototype.initialize = function() {
        ...
        this._controls.$previous =
            a("<" + c.navElement + ">")
                ...
                .on("click",
                    a.proxy(function(a) { this.prev(c.navSpeed) }, this)),
        this._controls.$next =
            a("<" + c.navElement + ">")
        ...
        var a, b, c,
            ...
            h = g.center || g.autoWidth || g.dotsData ? 1
                                                      : g.dotsEach || g.items;
        ...
        return a
            .grep(this._pages,
                  a.proxy(function(a, c) { return a.start <= b && a.end >= b },
                          this))
            .pop()
