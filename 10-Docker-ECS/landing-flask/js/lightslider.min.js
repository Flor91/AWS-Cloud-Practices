  ...
  a.fn.lightSlider = function(b) {
    ...
    return (
                 ...
                 if ((e.autoWidth === !1 && (b = e.item),
                   ...
                   for (var c = 0; c < e.responsive.length; c++)
                     i < e.responsive[c].breakpoint &&
                         ((j = e.responsive[c].breakpoint),
                          (k = e.responsive[c]));
                 if ("undefined" != typeof k && null !== k)
                   for (var d in k.settings)
                     k.settings.hasOwnProperty(d) &&
                         (("undefined" == typeof f[d] || null === f[d]) &&
                              (f[d] = e[d]),
                          (e[d] = k.settings[d]));
        ...
        (z.calSW =
             function() {
               e.autoWidth === !1 &&
                   (v = (o - (e.item * e.slideMargin - e.slideMargin)) /
                        e.item);
             }),
        (z.calWidth =
             function(a) {
          ...
          controls : function() {
            e.controls &&
                (g.after('<div class="lSAction"><a class="lSPrev">' +
                         ...
                         "</a></div>"),
                 e.autoWidth ? z.calWidth(!1) < o && p.find(".lSAction").hide()
          ...
          initialStyle : function() {
            ...
            "fade" === e.mode &&
                ...
                e.vertical ? (p.parent().addClass("vertical"),
                              (o = e.verticalHeight), p.css("height", o + "px"))
                           : (o = g.outerWidth()),
                h.addClass("lslide"),
                          ...
                          function() {
                            if (z.calWidth(!0) > o) {
                              ...
                              if (f < g.find(".clone.left").length)
                                for (var i = 0;
                                     i < g.find(".clone.left").length - f; i++)
                                  h.eq(i).remove();
                              if (f < g.find(".clone.right").length)
                                for (var j = h.length - 1;
                                     ...
                                     j--)
                                  q--, h.eq(j).remove();
                              for (var k = g.find(".clone.right").length; f > k;
                                   k++)
                                g.find(".lslide")
                                    .eq(k)
                                    .clone()
                ...
                c.find("img").length
                    ? c.find("img")[0].complete
                          ...
                          : c.find("img").on(
                                "load",
                                function() {
                                  setTimeout(function() { f(), x || d.auto(); },
                                             100);
                                })
                    : x || d.auto();
          },
            ...
            if (!y) {
              ...
              p.find(".lightSlider").addClass("lsGrab"),
                  p.on("mousedown", function(b) {
                    return o > m && 0 !== m
                               ? !1
                               : void ("lSPrev" !== a(b.target).attr("class") &&
        ...
        d.build(), (z.init = function() {
          z.chbreakpoint(),
              e.vertical === !0
                  ? ((o = e.item > 1 ? e.verticalHeight : h.outerHeight()),
                     p.css("height", o + "px"))
                  : (o = p.outerWidth()),
              e.loop === !0 && "slide" === e.mode && z.clone(), z.calL(),
              "slide" === e.mode && g.removeClass("lSSlide"),
              "slide" === e.mode && (z.calSW(), z.sSW()),
              setTimeout(
                  function() { "slide" === e.mode && g.addClass("lSSlide"); },
                  1e3),
              ...
              e.autoWidth === !1
                  ? h.length <= e.item ? p.find(".lSAction").hide()
                                       : p.find(".lSAction").show()
                  : z.calWidth(!1) < o && 0 !== m ? p.find(".lSAction").hide()
                                                  : p.find(".lSAction").show();
          ...
          q * e.slideMove < l - e.slideMove && a
              ...
              : e.loop === !0
                    ...
                    : e.slideEndAnimation === !0 &&
                          (g.addClass("rightEnd"),
                           setTimeout(function() { g.removeClass("rightEnd"); },
                                      400));
        }), (g.mode = function(a) {
          e.adaptiveHeight === !0 && e.vertical === !1 &&
              g.css("height", h.eq(q).outerHeight(!0)),
              n === !1 &&
                  ("slide" === e.mode
                       ...
                       : d.doCss() &&
                             ("" !== e.speed &&
                                  g.css("transition-duration", e.speed + "ms"),
                              "" !== e.cssEasing &&
          ...
          g.lightSlider &&
              ((g.goToPrevSlide = function() {}),
               ...
               g.removeClass(
                   ...
                   .unwrap()
                   .unwrap(),
               g.children().removeAttr("style"), h.removeClass("lslide active"),
               g.find(".clone").remove(), (h = null), (x = null), (n = !1),
               (q = 0));
        }), setTimeout(function() {
