...
!(function(a, b) {
    ...
    return [ b, c ];
       ...
       var c = document, d = function(b) {
         if ("object" != typeof window.google || !window.google.maps)
           return (
               "object" == typeof window.console && window.console.error &&
                   console.error(
         ...
         var e,
             f = function(a, b) { return void 0 === a ? b : a; }, j = this,
             k =
                 [
                   "bounds_changed",
                   "center_changed",
         ...
         (this.buildContextMenu = function(a, b) {
           ...
           google.maps.event.addDomListener(f, "mouseout", function(a) {
             (a.relatedTarget && this.contains(a.relatedTarget)) ||
                 window.setTimeout(function() { f.style.display = "none"; },
                                   400);
           }, !1);
  ...
  (j.prototype.createControl = function(a) {
    ...
    return (
        b.setMap(this.map), null != a.auto_show && (c = a.auto_show),
        (b.onAdd = function() {
  ...
  return (
           ...
           function(b) {
             ...
             var c = {
               ...
               waypoints : [],
                 ...
                 d = a(c, b);
             (d.origin =
                  /string/.test(typeof b.origin)
                      ? b.origin
                      : new google.maps.LatLng(b.origin[0], b.origin[1])),
                 (d.destination =
                      /string/.test(typeof b.destination)
                          ? b.destination
                          : new google.maps.LatLng(b.destination[0],
                                                   b.destination[1])),
                 (d.travelMode = k), (d.unitSystem = l), delete d.callback,
                 delete d.error;
           ...
           function(d) {
             ...
             if (d.path) {
               ...
               g.getElevationAlongPath(
                   h,
                   function(a, b) { e && "function" == typeof e && e(a, b); });
             } else
               delete d.path, delete d.samples,
                   g.getElevationForLocations(
                       d,
                       function(a,
                                b) { e && "function" == typeof e && e(a, b); });
           }),
           ...
           function(a) {
             ...
             if (a.origin && a.destination)
               this.getRoutes({
                 ...
                 callback : function(c) {
                   if ((c.length > 0 && a.start && a.start(c[c.length - 1]),
                     ...
                     var d = c[c.length - 1];
                     if (d.legs.length > 0)
                       for (var e, f = d.legs[0].steps, g = 0; (e = f[g]);
                            g++) {
                         e.step_number = g;
                         var h = {
                           path : e.path,
               ...
               for (var c, d = a.route.legs[0].steps, e = 0; (c = d[e]); e++) {
                 ...
                 a.hasOwnProperty("icons") && (f.icons = a.icons),
                     b.drawPolyline(f), a.step(c);
               }
           }),
      (j.Route =
           function(a) {
             (this.origin = a.origin), (this.destination = a.destination),
                 (this.waypoints = a.waypoints), (this.map = a.map),
                 (this.route = a.route), (this.step_count = 0),
      ...
      (j.prototype.toImage =
           function(a) {
             var a = a || {}, b = {};
             if (((b.size =
                       a.size || [ this.el.clientWidth, this.el.clientHeight ]),
                  (b.lat = this.getCenter().lat()),
                  (b.lng = this.getCenter().lng()), this.markers.length > 0)) {
               b.markers = [];
               for (var c = 0; c < this.markers.length; c++)
                 b.markers.push({
             ...
             if (this.polylines.length > 0) {
               ...
               (b.polyline = {}),
                   (b.polyline.path =
                        google.maps.geometry.encoding.encodePath(d.getPath())),
           ...
           function(a) {
             function b(a, b) {
               if ("#" === a[0] && ((a = a.replace("#", "0x")), b)) {
                 if (((b = parseFloat(b)), (b = Math.min(1, Math.max(b, 0))),
                      0 === b))
                   return "0x00000000";
               ...
               for (var m, n, o = 0; (c = f[o]); o++) {
                 (m = []),
                     c.size && "normal" !== c.size
                         ...
                         : c.icon && (m.push("icon:" + encodeURI(c.icon)),
                                      delete c.icon),
      ...
      (j.prototype.addMapType =
           function(a, b) {
             if (!b.hasOwnProperty("getTileUrl") ||
           ...
           function(a, b, c) {
             if (-1 == j.custom_events.indexOf(a))
               ...
               for (var d = c.registered_events[a], e = 0; e < d.length; e++)
                 !(function(a, b, c) { a.apply(b, [ c ]); })(d[e].handler, c,
                                                             b);
           }),
      (j.geolocate =
           function(a) {
