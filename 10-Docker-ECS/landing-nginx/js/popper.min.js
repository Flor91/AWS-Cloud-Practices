...
function l(e, t) {
  ...
  return ((e.top += i * r), (e.bottom += i * r), (e.left += n * r),
          (e.right += n * r), e);
}
function f(e, t) {
...
function u(e, o) {
  ...
  if (((h.marginTop = 0), (h.marginLeft = 0), !i && r)) {
    ...
    (h.top -= f - u), (h.bottom -= f - u), (h.left -= m - b),
        (h.right -= m - b), (h.marginTop = u), (h.marginLeft = b);
  }
  ...
  if ("viewport" === r)
    ...
    if ("HTML" === a.nodeName && !w(s)) {
      ...
      (p.top += l.top - l.marginTop), (p.bottom = m + l.top),
          (p.left += l.left - l.marginLeft), (p.right = c + l.left);
    } else
      p = l;
  }
...
function A(e, t, o, i) {
  ...
  var r = n(e);
  return (H(r, "scroll", o.updateBound, o.scrollParents), (o.scrollElement = r),
          (o.eventsEnabled = !0), o);
}
function I() {
  this.state.eventsEnabled || (this.state = A(this.reference, this.options,
      ...
      modifiers : {
              ...
              (m || b || y) &&
                  ((e.flipped = !0), (m || b) && (i = p[d + 1]),
                   ...
                   (e.offsets.popper = se({}, e.offsets.popper,
                                          S(e.instance.popper,
                                            e.offsets.reference, e.placement))),
        ...
        computeStyle : {
          ...
          fn : function(e, t) {
            ...
            var s, d, a = void 0 === p ? t.gpuAcceleration : p,
                      ...
                      u = "right" === i ? "left" : "right", b = W("transform");
        ...
        applyStyle : {
          ...
          onLoad : function(e, t, o, i, n) {
            var r = O(n, t, e),
                p = v(o.placement, r, t, e, o.modifiers.flip.boundariesElement,
