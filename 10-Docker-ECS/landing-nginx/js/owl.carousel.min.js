    ...
    grabClass : "owl-grab",
      ...
      (e.prototype.initialize = function() {
        ...
        this.$element.addClass(this.options.loadingClass),
            (this.$stage = a("<" + this.settings.stageElement + ' class="' +
        ...
        (a = this.normalize(a)),
            a !== d && ((this._speed = 0), (this._current = a),
        ...
        if (e.loop)
          ...
          for (b = this._items.length, c = this._items[--b].width(),
          ...
          (e.prototype.watch = function() {
            this._interval ||
                ((this._visible = this._core.$element.is(":visible")),
                 (this._interval =
                      b.setInterval(a.proxy(this.refresh, this),
