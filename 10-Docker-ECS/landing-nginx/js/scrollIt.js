/**
 * ScrollIt
 * ScrollIt.js(scroll•it•dot•js) makes it easy to make long, vertically
 * scrolling pages.
 *
...
var pluginName = 'ScrollIt', pluginVersion = '1.0.3';
...
$.scrollIt = function(options) {
   ...
   * DECLARATIONS
   */
  var settings = $.extend(defaults, options), active = 0,
  ...
  var navigate = function(ndx) {
    ...
    $('html,body')
        .animate({scrollTop : targetTop, easing : settings.easing},
                 settings.scrollTime);
  };
